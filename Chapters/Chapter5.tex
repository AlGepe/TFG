...
The second modelling of the \neff consists on 3 different areas where the carrier density is linear with depth. Restrictions are imposed in the allowed values for each zone so that continuity is ensured. 
