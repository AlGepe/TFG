...
To explain why the \neff gets modified after irradiation, we will follow the argument presented by V.Eremin\cite{Eremin}. After enough radiation the defects and their correspondant deep levels can be considered uniformely distributed throughout the detector.
